                                    ...
                                    <div class="single-products">
                                        ...
                                        <div class="product-overlay">
                                            <div class="overlay-content">
                                                ...
                                                @endif
                                                <h2>
                                                    Rs. {{$product->offer ? $product->offer_price : $product->price}}</h2>
                                                <p>{{$product->name}} | {{$product->volume}}</p>
                                                <p>Availability
                                                    : {{$product->stock >0 ? $product->stock : 'Product Out Of Stock'}}</p>
                                    ...
                                    @if(Auth::check())
                                        <div class="choose">
                                            <ul class="nav nav-pills nav-justified">
                                                ...
                                                <li><a href="{{route('add-to-wishlist',$product->slug)}}"><i
